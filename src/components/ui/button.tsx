...
const buttonVariants = cva(
  ...
  "relative items-center whitespace-nowrap text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary flex items-center justify-center text-white hover:bg-primary/90 active:scale-95 shadow-sm rounded-sm",
        ...
        outline:
          "flex text-foreground bg-transparent justify-center items-center gap-3 border border-foreground/30 shadow-sm hover:bg-muted active:scale-95",
