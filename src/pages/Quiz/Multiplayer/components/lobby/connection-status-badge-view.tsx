...
export interface ConnectionStatusBadgeViewProps {
  status: ConnectionStatus;
}

/**
 * Presentational half of ConnectionStatusBadge. Split out of the hook-wired component
 * (useConnectionStatus pings a real external endpoint) so it can be previewed in Storybook —
 * same pattern as MultiplayerGame / QuizInterface.
 */
export const ConnectionStatusBadgeView = ({ status }: ConnectionStatusBadgeViewProps) => {
