...
export function QuizSelection() {
  ...
  return (
    <div className="relative min-h-screen pb-20 text-foreground bg-cover bg-center bg-[url('/assets/backgroundImage3.jpgs')] dark:bg-[url('/assets/darkBackgroundImage.jpg')] font-header">
      <QuizHeader />
