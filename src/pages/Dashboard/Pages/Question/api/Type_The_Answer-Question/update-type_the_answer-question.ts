...
export type UpdateTypeTheAnswerQuestionInput = z.infer<
  typeof updateTypeTheAnswerQuestionInputSchema
>;

export const updateTypeTheAnswerQuestion = ({
  data,
  questionId,
}: {
...
export const useUpdateTypeTheAnswerQuestion = ({
  mutationConfig,
}: UseUpdateTypeTheAnswerQuestionOptions = {}) => {
