...
export const TrueFalseFormCard: React.FC<TrueFalseFormCardProps> = ({ question }) => {
  ...
  }, [debouncedQuestionState, question]) // Updated dependency array
    ...
    >
      <div className="space-y-6 pt-4">
        <div className="text-center">
          <Label className="text-lg font-semibold text-foreground">Choose the correct answer</Label>
        </div>
        ...
        <div className="grid grid-cols-2 gap-6 max-w-lg mx-auto">
          ...
          >
            ...
            <div
              className={`absolute inset-0 rounded-2xl ${
                correctAnswer === true ? "shadow-inner" : "shadow-inner opacity-30"
              }`}
            />
              ...
              <div className="text-center">
                ...
                <div
                  className={`text-sm mt-1 transition-colors ${
                    correctAnswer === true ? "text-emerald-100" : "text-muted-foreground"
                  }`}
                >
          ...
          >
            ...
            <div
              className={`absolute inset-0 rounded-2xl ${
                correctAnswer === false ? "shadow-inner" : "shadow-inner opacity-30"
              }`}
            />
            ...
            <div className="relative flex flex-col items-center space-y-4">
              <div
                className={`relative transition-all duration-300 ${
                  correctAnswer === false ? "scale-110" : "group-hover:scale-105"
                }`}
              >
                {correctAnswer === false ? (
              ...
              <div className="text-center">
                ...
                <div
                  className={`text-sm mt-1 transition-colors ${
                    correctAnswer === false ? "text-red-100" : "text-muted-foreground"
                  }`}
                >
