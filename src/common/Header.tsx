...
const Header = ({ BackgroundColor }: HeaderProps) => {
  ...
  return (
    <HeaderComponent
      ref={headerRef}
      className={`fixed top-0 left-0 right-0 z-30 text-lg shadow-md border-b border-border h-16 grid grid-cols-5 items-center px-4 transition-transform duration-400 ${
