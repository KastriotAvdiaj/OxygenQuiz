...
namespace QuizAPI.Migrations
{
    ...
    [Migration("20260914174406_AddMultiplayerMatch")]
    partial class AddMultiplayerMatch
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuizAPI.Models.Ai.AiGenerationUsage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("QuestionsReturned")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("QuizAPI.Models.InviteCode", b =>
                {
                    ...
                    b.HasIndex("GrantedRoleId");

                    b.HasIndex("IntendedEmail");
            ...
            modelBuilder.Entity("QuizAPI.Models.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("QuizAPI.Models.Quiz.Match", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("QuizAPI.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("ClosureReminderSentAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("QuizAPI.Models.InviteCode", b =>
                {
                    ...
                    b.HasOne("QuizAPI.Models.Role", "GrantedRole")
                        .WithMany()
                        .HasForeignKey("GrantedRoleId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("GrantedRole");
                });
            ...
            modelBuilder.Entity("QuizAPI.Models.Quiz.Match", b =>
                {
                    b.HasOne("QuizAPI.Models.User", "HostUser")
                        .WithMany()
                    ...
                    b.HasOne("QuizAPI.Models.User", "WinnerUser")
                        .WithMany()
