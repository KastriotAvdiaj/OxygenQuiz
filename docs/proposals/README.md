...
| [`quiz-view-redesign.md`](./quiz-view-redesign.md) | **Partly shipped** — the one-page layout is built (see [`../quiz/quiz-analytics-page.md`](../quiz/quiz-analytics-page.md)). What remains: should the analytics DTO grow to carry per-option counts, submitted answer strings and drop-off point? | Backend work, plus a date-range parameter before the 7d/30d/All toggle can be honest. |
